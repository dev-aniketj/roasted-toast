...
[![1.0.2](https://jitpack.io/v/dev-aniketj/RoastedToast.svg)](https://jitpack.io/#dev-aniketj/RoastedToast)
...
```
dependencies {
	        implementation 'com.github.dev-aniketj:RoastedToast:1.0.2'
	}
```
